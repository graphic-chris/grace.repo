...
class FormPostController extends Controller
{
    ...
    public function postContact(Request $request)
    {
        ...
        Mail::send('emails.contact-form.form', $formData, function ($message) {
            ...
            $message->to('noreply@graceadmin.com', 'Lorem Lipsum')->subject($request->get('subject'));
        });
        */

        /*
        $mailer = new Mailer;
        $mailer->send('emails.contact-form.form', 'admin@graceadmin.com', $request->get('subject'), $formData);
        */
